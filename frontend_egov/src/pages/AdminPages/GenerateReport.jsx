...
const GenerateReport = () => {
  ...
  return (
    <div className="max-w-4xl w-full mx-auto p-6 bg-white shadow-md rounded-lg mt-8 border">
      <h2 className="text-3xl font-bold text-gray-800 text-center mb-6">System Report</h2>
      <div className="mb-4">
        <h3 className="text-xl font-semibold text-gray-700 border-b pb-2">Customers by Demand Type</h3>
        <ul className="mt-2">
      ...
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-gray-700 border-b pb-2">Customers by Branch</h3>
        <ul className="mt-2">
      ...
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-gray-700 border-b pb-2">Bill Status</h3>
      ...
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-gray-700 border-b pb-2">Total Revenue</h3>
        <p className="mt-2 text-green-600 text-lg font-bold">₹ {report.totalRevenue.toFixed(2)}</p>
      </div>
    </div>
  );
};
